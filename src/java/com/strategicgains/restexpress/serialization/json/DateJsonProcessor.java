...
/**
 * A SerializationProcessor to handle JSON input/output.  It anticipates ISO 8601-compatible date formats
 * and outputs dates as ISO 8601 dates (yyyy-MM-dd).
 * 
 * @author toddf
 * @since Nov 29, 2010
 */
...
extends DefaultJsonProcessor
{
	public DateJsonProcessor()
    {
	    super(new GsonBuilder()
	    	...
	    	.setDateFormat(DateAdapterConstants.DATE_OUTPUT_FORMAT)
	    	.create()
	    );
    }
}
