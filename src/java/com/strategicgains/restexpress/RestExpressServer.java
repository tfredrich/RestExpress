...
public class RestExpressServer
{
	...
	public RestExpressServer(String name)
	{
		super();
		this.name = name;
	}
	...
	public RestExpressServer setPort(int port)
	{
		this.port = port;
		return this;
	}
	...
	public RestExpressServer setRoutes(RouteDeclaration routes)
	{
		this.routes = routes;
		return this;
	}

	public RestExpressServer putSerializationProcessor(String format, SerializationProcessor processor)
	{
	...
	public RestExpressServer setSerializationResolver(Resolver<SerializationProcessor> serializationResolver)
	{
	...
	public RestExpressServer setDefaultSerializationFormat(String defaultSerializationFormat)
	{
		this.defaultSerializationFormat = defaultSerializationFormat;
		return this;
	}

	public RestExpressServer addMessageObserver(MessageObserver observer)
	{
	...
	public RestExpressServer addPreprocessor(Preprocessor processor)
	{
	...
	public RestExpressServer addPostprocessor(Postprocessor processor)
	{
	...
	public RestExpressServer setUseSystemOut(boolean useSystemOut)
	{
