...
/**
 * Verifies the response contents prior to writing it to the output stream to ensure that it conforms
...
public final class HttpSpecification
{
	...
	/**
	 * Responses 1xx, 204 (No Content) and 304 (Not Modified) must not return a response body.
	 * 
	 * @param response
	 */
