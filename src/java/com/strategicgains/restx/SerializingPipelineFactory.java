 ...
 * @since July 30, 2010
 */
public class SerializingPipelineFactory
implements ChannelPipelineFactory
{
	...
	public SerializingPipelineFactory(RouteMapping routes)
	{
		this(false, false, routes);
	}

	public SerializingPipelineFactory(boolean useSsl, boolean useChunked, RouteMapping routes)
	{
		super();
