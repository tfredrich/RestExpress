...
public class CommentController
{
	...
	public Comment create(Request request, Response response)
	{
		...
		String entryId = request.getHeader(Constants.ENTRY_ID_HEADER, "Blog Entry ID not provided.");
	...
	{
		String id = request.getHeader(Constants.COMMENT_ID_HEADER, "Comment ID not provided.");
		return repo.read(id);
	}
